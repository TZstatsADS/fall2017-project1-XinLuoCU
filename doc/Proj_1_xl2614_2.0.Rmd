...
This part explores the simialrities and differences between inaugration speeches and nomination speeches thoroughly to get an insight for presidents' changes. Except for some general features, here we also discuss 2 example in details, which are both provided by Trump.


2. Similarities between 2 Consecutive Term Inaugrations Speeches
By studying 2 succussive terms' inaugration speeches, we could conclude the issues really matter to president of these 2 terms, having an insight about these 8 years. For those 2-term presidents, we could be informed about their main contributions and focus, because they love to mention their contributions in the second term inaugration speeches.
...
Therefore, I think presidents did change the way they talk from the nomination to inaugration. Using more short sentcences might represent they feel more freely in their nomination speeches, because the inaugration is a more formal occasion, they will pay more attention to the their sentences and speech structure.
...
The keywords selected for each speech is very accurate. For example, The keyword of Obama's nomination speech is his competitor in the election, "Mccain", but only  the "icy", "stroms" showed in his inaugration speech, reflecting the financial crisis just happened. In Bush's inaugration wordcloud, there are big "Iraq" and "Afghanistan", indicating the Iraq war began in 2003, but they all disappeared in the word cloud of inaugration speech. So, has the contents of presidents' speeches changed a lot from nomination to inaugration

Generally speaking, we can see the nomination speeches always have more words and these words are very specific, like the country names and people names, while Inaugration speeches intend to contain the "bigger" words. For example, Bush's "iraq" and "terrorist" are replaced by "tyranny" and "defended".

Besides, in nomination speeches, speakers would like to provide people detailed plans and promises in order to receive supports, while the inaugration speech do not have that strong purpose. While making inaugration speeches, speakers are more likely to summarize the situation of the country and the his main claims, they would not give that much details to people under the limitation of time.
...
###PART II:  Similarities between 2 consecutive terms Inaugrations Speeches

By exploring the similar words of two successive inaugration speeches , we can have a insight about the issues which the presidents care about. They might be problems have not yet been resolved or aspects this president focus on. Here I use the latest George W Bush and Obama's speeches as an example.
```{r,warning=F,message=F}
Obama1<-tdm.tidy%>%
...
The shared key words of two inaugration speeches of Obama contain "jobs", "pay", "afford" and "crisis", indicating the 2007-2008 financial crisis that Obama encountered and he still consider it is  his main contribution and will pay more attention to it in the following term.

Therefore, I think the similarities do exist. Both two presidents maintain the things they care in the two consecutive inaugration speeches.
